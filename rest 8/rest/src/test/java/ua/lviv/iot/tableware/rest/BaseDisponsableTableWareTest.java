...
public abstract class BaseDisponsableTableWareTest {
        ...
        public void createExerciseProgram() {
            ...
            disponsableTableWareList.add(new Glass("Sasha",12,34,22,MatherialType.PAPER,23,45,5,3));
            disponsableTableWareList.add(new Fork("Shvachek",132,304,212,MatherialType.WOOD,23,425));
            disponsableTableWareList.add(new Glass("Yuriy",50,33,122,MatherialType.PLASTIC,24,350,12,43));
