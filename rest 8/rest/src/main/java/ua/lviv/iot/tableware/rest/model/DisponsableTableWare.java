...
public abstract class DisponsableTableWare {
   ...
   public String toCSV() {
    ...
    public boolean equals(Object o) {
        ...
        DisponsableTableWare that = (DisponsableTableWare) o;
        return getManufacturer() == that.getManufacturer() &&
        			getPrice() == that.getPrice() &&
        				getFireResistance() == that.getFireResistance() &&
                        		getDateOfManufacture() == that.getDateOfManufacture() &&
                                		getMatherial().equals(that.getMatherial());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getManufacturer(), getPrice(), getFireResistance(), getDateOfManufacture(), getMatherial());
    }

    @Override
    public String toString() {
        return "DisponsableTableWare [manufacturer=" + manufacturer + ", price=" + price
                + ", fireResistance=" + fireResistance + ", dateOfManufacture=" + dateOfManufacture + ", matherial=" + matherial +  "]";
    }
...
public class DisponsableTableWare {
    private String manufacturer;
    private int price;
    private int fireResistance;
    private int dateOfManufacture;
